...
function execute_script() {
    ...
    wget https://github.com/t3rn/executor-release/releases/download/v0.30.0/executor-linux-v0.30.0.tar.gz
    ...
    # 解压文件到当前目录
    echo "正在解压文件..."
    tar -xvzf executor-linux-v0.30.0.tar.gz
    ...
    # 删除压缩文件
    echo "删除压缩包..."
    rm executor-linux-v0.30.0.tar.gz
